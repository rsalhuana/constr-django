...
class Clientes(models.Model):
    ...
    vc_codEstado =models.ForeignKey('GeneralDetalle', db_column='vc_codEstado',related_name='vc_codEstado_C', on_delete=models.PROTECT) 
    vc_codTipoDocumento = models.ForeignKey('GeneralDetalle', db_column='vc_codTipoDocumento',related_name='vc_codTipoDocumento_C', on_delete=models.PROTECT)  # Field name made lowercase.
    ...
    b_retenedor = models.BooleanField(db_column='b_retenedor', blank=False, null=False)  # Field name made lowercase. This field type is a guess.
    b_flaginactivo = models.BooleanField(db_column='b_flagInactivo', blank=False, null=False)  # Field name made lowercase. This field type is a guess.
...
class Colaborador(models.Model):
    ...
    vc_codtipodocumento = models.ForeignKey('GeneralDetalle', db_column='vc_codTipoDocumento',related_name='vc_codTipoDocumento_Colb', on_delete=models.PROTECT)  # Field name made lowercase.
    vc_codsituacion = models.ForeignKey('GeneralDetalle', db_column='vc_codSituacion',related_name='vc_codSituacion_Colb', on_delete=models.PROTECT)  # Field name made lowercase.
    vc_numdocumento = models.CharField(db_column='vc_numDocumento', max_length=12)  # Field name made lowercase.
    ...
    vc_codestado = models.ForeignKey('GeneralDetalle', db_column='vc_codEstado', related_name='vc_codEstado_colab', on_delete=models.PROTECT) 
    #vc_codestado = models.CharField(db_column='vc_codEstado', max_length=3)  # Field name made lowercase.
...
#     vc_codRepcion = models.ForeignKey('GeneralDetalle', db_column='vc_codRepcion', related_name='vc_codRepcion')  # Field name made lowercase.
#     id_proyecto = models.ForeignKey('Proyectos', db_column='id_proyecto', related_name='proyectos')
#     vc_codEstado = models.ForeignKey('GeneralDetalle', db_column='vc_codEstado', related_name='vc_codEstado')  # Field name made lowercase.
#     dt_emision = models.DateField()
#     id_proveedor = models.ForeignKey('Proveedor', db_column='id_proveedor')
#     vc_codTipoComprobante = models.ForeignKey('GeneralDetalle', db_column='vc_codTipoComprobante' , related_name='vc_codTopoComprobante')  # Field name made lowercase.
...
#     vc_codCondicionPago = models.ForeignKey('GeneralDetalle', db_column='vc_codCondicionPago',related_name='vc_codCondicionPago')  # Field name made lowercase.
...
#     id_ingresoCabecera = models.ForeignKey(IngresoCabecera, db_column='id_ingresoCabecera')  # Field name made lowercase.
...
#     vc_codConformidad = models.ForeignKey(GeneralDetalle, db_column='vc_codConformidad')  # Field name made lowercase.
#     b_flagInactivo = models.BooleanField(db_column='b_flagInactivo')  # Field name made lowercase. This field type is a guess.
#     dt_crea = models.DateTimeField()
#     vc_usuarioCrea = models.CharField(db_column='vc_usuarioCrea', max_length=50)  # Field name made lowercase.
#     vc_ipCrea = models.CharField(db_column='vc_ipCrea', max_length=20)  # Field name made lowercase.
...
#     id_ingresoCabecera = models.ForeignKey(IngresoCabecera, db_column='id_ingresoCabecera')  # Field name made lowercase.
#     vc_codDireccionGasto = models.ForeignKey(GeneralDetalle, db_column='vc_codDireccionGasto')  # Field name made lowercase.
#     id_materiales = models.ForeignKey('Materiales', db_column='id_materiales')
...
class Materiales(models.Model):
    ...
    nu_stockMaximo = models.DecimalField(db_column='nu_stockMaximo', max_digits=9, decimal_places=2, blank=True, null=True)  # Field name made lowercase.    b_flagInactivo = models.BooleanField(db_column='b_flagInactivo')  # Field name made lowercase. This field type is a guess.
    ...
    vc_usuarioEdita = models.CharField(db_column='vc_usuarioEdita', max_length=50, blank=True, null=True)  # Field name made lowercase.
    vc_ipEdita = models.CharField(db_column='vc_ipEdita', max_length=20, blank=True, null=True)  # Field name made lowercase.
    id_codSituacion = models.ForeignKey('GeneralDetalle', db_column='id_codSituacion', related_name='id_codSituacion', on_delete=models.PROTECT)  # Field name made lowercase.
    nu_stockActual = models.DecimalField(db_column='nu_stockActual', max_digits=9, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    ...
    id_statusAprobado = models.IntegerField(db_column='id_statusAprobado', blank=True, null=True)
    class Meta:
        managed = True
        db_table = 'Materiales'
        permissions = (
            ("exportar_material", "Exportar Materiales"),
            ("aprobar_material", "Aprobar Material"),
            ("notificar_material", "Notificar Material"),
            ("ver_material", "Ve Material"),
        )
...
class Proveedor(models.Model):
    ...
    #vc_codestado = models.CharField(db_column='vc_codEstado', max_length=3)  # Field name made lowercase.
    vc_codestado = models.ForeignKey('GeneralDetalle', db_column='vc_codEstado', related_name='vc_codEstado_prov', on_delete=models.PROTECT) 
    ...
    #b_flaginactivo = models.BooleanField(db_column='b_flagInactivo', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    b_flaginactivo = models.BooleanField(db_column='b_flagInactivo', blank=False, null=False)
    dt_crea = models.DateTimeField()
    vc_usuariocrea = models.CharField(db_column='vc_usuarioCrea', max_length=50)  # Field name made lowercase.
    vc_ipcrea = models.CharField(db_column='vc_ipCrea', max_length=20)  # Field name made lowercase.
    dt_edita = models.DateTimeField(blank=True, null=True)
...
class UnidadMedida(models.Model):
    ...
    def __unicode__(self):
        return self.vc_descripcionCorta 
    class Meta:
        managed = True
